...
eoseulleong.addEventListener("click", function () {
  btnnumber = eoseulleong.classList[1]
  changeBtnCss(0);
  clickPosition = "other";
  // 위치 중앙으로 이동
